...
import { TrashBox } from "@/app/(main)/components/trash-box";
    ...
    return(
        <>
            ...
            className={cn("group/sidebar h-full bg-secondary overflow-y-auto relative flex w-60 flex-col z-[99999]", isResetting && "transition-all ease-in-out duration-300", isMobile && "w-0 ")}>
                ...
                <div>
                    <UserItem />
                    <Item label="Search" icon={Search} isSearch onClick={search.toggle}/>
                    <Item label="Settings" icon={Settings} onClick={() => {}}/>
                    <Item onClick={handleCreate} label="New page" icon={PlusCircle}/>
                </div>
                <div className="mt-4">
                    <DocumentList/>
                    <Item label="Add a new page" icon={Plus} onClick={handleCreate}/>
                    <Popover>
